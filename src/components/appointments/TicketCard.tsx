...
export default function TicketCard({
  ...
  return (
    ...
    >
      {/* Date stub */}
      <div
        className={`relative w-[88px] sm:w-[100px] shrink-0 flex flex-col items-center justify-center gap-0.5 py-3 border-e-2 border-dashed border-[hsl(var(--color-border-soft))] ${
          dimmed
      ...
      >
        ...
        {/* punch-hole notches */}
        <span className="absolute -end-[7px] -top-[7px] w-3.5 h-3.5 rounded-full bg-[hsl(var(--color-bg))]" />
        <span className="absolute -end-[7px] -bottom-[7px] w-3.5 h-3.5 rounded-full bg-[hsl(var(--color-bg))]" />
      </div>
