...
export default function TrackerBanner() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[hsl(var(--color-primary))] to-[hsl(var(--color-primary-strong))] p-6 sm:p-8 text-white mb-6 group">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
        <div className="flex flex-col md:flex-row items-center gap-5">
          <div className="w-16 h-16 shrink-0 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white">
        ...
        <Link 
          ...
          className="shrink-0 w-full md:w-auto px-6 py-3.5 bg-white text-[hsl(var(--color-primary-strong))] font-black text-sm rounded-xl hover:bg-[hsl(var(--color-bg-soft))] hover:-translate-y-1 transition-all flex items-center justify-center gap-2"
        >
