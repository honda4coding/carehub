    ...
    <>
      ...
      {open ? null : (
        <button
          ...
          className="md:hidden fixed top-3.5 left-4 z-80 w-9 h-9 flex items-center justify-center rounded-[10px] bg-[hsl(var(--color-bg-surface))] border border-[hsl(var(--color-border))] text-[hsl(var(--color-text-muted))] shadow-sm"
