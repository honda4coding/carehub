...
export default function TrustMetrics() {
  const metrics = [
    {
      icon: <LuLockKeyhole className="w-8 h-8 text-[hsl(var(--color-primary))]" />,
      title: "Secure Authentication",
      desc: "All user sessions are protected using industry-standard JSON Web Tokens (JWT) and encrypted passwords.",
    },
    {
      icon: <LuShieldCheck className="w-8 h-8 text-[hsl(var(--color-primary))]" />,
    ...
    {
      icon: <LuFileBadge className="w-8 h-8 text-[hsl(var(--color-primary))]" />,
    ...
    <section className="w-full bg-[hsl(var(--color-bg-soft))] py-24 lg:py-32 relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl lg:text-4xl font-black text-[hsl(var(--color-text))] tracking-tight mb-4">
