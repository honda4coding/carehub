...
export default function CTASection() {
  return (
    <section className="w-full bg-[hsl(var(--color-bg))] py-24 lg:py-32 px-6 lg:px-10">
      <div className="max-w-5xl mx-auto rounded-[3rem] bg-linear-to-br from-[hsl(var(--color-primary))] to-[hsl(var(--color-secondary))] p-10 lg:p-20 text-center relative overflow-hidden group">
