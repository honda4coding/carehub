...
import {
  LuCalendar, LuStethoscope, LuChevronDown, LuChevronUp,
  LuFileText, LuPill, LuActivity, LuHeartPulse,
  LuThermometer, LuDroplets, LuWeight, LuRuler,
  LuImage, LuExternalLink
} from "react-icons/lu";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Chevron */}
        <div className="flex items-start pt-4 pr-4 pl-1 text-[hsl(var(--color-text-muted))]">
          ...
          <div className="p-5">
            ...
            {activeTab === "notes" && (
              <div>
                ...
                {(record.allergies?.length > 0 || record.chronic?.length > 0 || record.surgeries?.length > 0) && (
