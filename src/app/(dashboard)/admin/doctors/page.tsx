          ...
          <div className="flex items-start justify-between mb-4 gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-[11px] font-bold px-2.5 py-1.5 rounded-[8px] border border-[hsl(var(--color-border))] text-[hsl(var(--color-text-muted))] hover:bg-[hsl(var(--color-bg-soft))] transition-colors whitespace-nowrap"
              >
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-2.5 pr-4">
                          <div className="flex items-center gap-2">
                            <div
                              className={`w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-black shrink-0 ${pickAvatar(doc._id)}`}
                            >
                        ...
                        {/* Specialty */}
                        <td className="py-2.5 pr-4 text-[12px] font-semibold text-[hsl(var(--color-text-muted))] whitespace-nowrap">
                          {doc.specialty ?? "—"}
                        </td>
