      ...
      <main className="flex-1 p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6 max-w-sm">
          ...
          <button
            ...
            className="bg-[hsl(var(--color-bg-surface))] border border-[hsl(var(--color-border))] rounded-2xl px-4 py-3 flex items-center gap-3 cursor-pointer hover:border-[hsl(var(--color-success)/0.4)] transition-all text-start"
          >
