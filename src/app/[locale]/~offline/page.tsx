    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-[hsl(var(--color-primary))] p-6 flex flex-col items-center justify-center text-white">
          ...
          <h1 className="text-2xl font-bold text-center">{t('noInternetConnection')}</h1>
        ...
        <div className="p-6">
          <div className="flex items-start space-x-3 bg-orange-50 border border-orange-100 p-4 rounded-xl mb-6">
            ...
            <div>
              <h3 className="font-semibold text-orange-900">{t('yourDataIsSafe')}</h3>
              <p className="text-sm text-orange-700 mt-1">
                {t('anyChangesYouSaved')}</p>
            </div>
          </div>

          <div className="space-y-4 mb-6">
            <h3 className="font-semibold text-gray-900 border-b pb-2">{t('supportContacts')}</h3>
            ...
            <div className="flex items-center space-x-3 text-sm">
              ...
              <div>
                <p className="font-medium text-gray-900">{t('technicalSupport247')}</p>
            ...
            <div className="flex items-center space-x-3 text-sm">
              ...
              <div>
                <p className="font-medium text-gray-900">{t('hospitalReception')}</p>
